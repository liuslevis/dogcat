...
SIZE = 128  # 28 MNIST ;224 for ImageNet models compatibility
TEST_DIR = 'data/input/raw/test/'
TRAIN_DIR = 'data/input/raw/train/'
BASE_DIR = 'data/input/'
...
def prep_images(paths, out_dir):
    ...
    for count, path in enumerate(paths):
        ...
        img_gry = gray_image(img_nrm)
        img_res = resize_image(img_gry, SIZE)
...
def main():
    ...
    base_out = os.path.join(BASE_DIR, '{}'.format(SIZE))
