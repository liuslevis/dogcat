...
# maxpool4 -> img/8 * 256(channel)
h_pool4 = max_pool_2x2(h_conv4)

# fc1 -> 256
scale = 8 * 8
W_fc1 = weight_variable([int(IMG_SIZE/scale)*256, 128])
b_fc1 = bias_variable([128])
h_pool4_flat = tf.reshape(h_pool4, [-1, int(IMG_SIZE/scale)*256])
