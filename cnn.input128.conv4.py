...
# conv3 -> img/8 * 128(channel)
W_conv4 = weight_variable([5,5,128,128])
b_conv4 = bias_variable([128])
h_conv4 = tf.nn.relu(conv2d(h_pool3, W_conv4) + b_conv4)

# maxpool4 -> img/16 * 128(channel)
h_pool4 = max_pool_2x2(h_conv4)

# fc1 -> 256
W_fc1 = weight_variable([int(IMG_SIZE/16/16)*128, 256])
b_fc1 = bias_variable([256])
h_pool4_flat = tf.reshape(h_pool4, [-1, int(IMG_SIZE/16/16)*128])
